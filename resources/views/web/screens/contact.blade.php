    ...
    <section class="py-16 bg-white">
        ...
        <div class="container mx-auto">
            <div class="grid lg:grid-cols-2 grid-cols-1 gap-10">
                <div>
                    <h3 class="text-3xl text-blue-900 font-bold ps-5 border-s-4 border-s-blue-900 mb-5">
                        Enquiry Now:
                    </h3>
                    <form id="enquiryForm" action="{{ route('enquiry.submit') }}" method="POST" class="flex flex-col gap-5"
                        ...
                        <button type="submit" class="bg-blue-900 text-white px-4 py-2 rounded">Send Message <i
                ...
                <div>
                    ...
                    <div class="text-lg">
                        <div class="flex gap-3 items-center py-5 border-b-2">
                            <i class="bi bi-phone text-blue-900 text-3xl"></i>
                            <div>
                                <div class="font-bold">
                                    Contact No.:
                                </div>
                        ...
                        <div class="flex gap-3 items-center py-5 border-b-2">
                            <i class="bi bi-envelope text-blue-900 text-3xl"></i>
                            <div>
                                <div class="font-bold">
                                    Email Address:
                                </div>
                        ...
                        <div class="flex gap-3 py-5">
                            <i class="bi bi-geo-alt text-blue-900 text-3xl"></i>
                            <address>
