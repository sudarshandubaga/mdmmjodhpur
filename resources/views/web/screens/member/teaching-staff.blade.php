            ...
            @foreach ($members as $type => $teams)
                ...
                <div class="mb-3">
                    @foreach ($teams as $team)
                        <div
                            class="rounded overflow-hidden border border-gray-200 lg:grid grid-cols-5 gap-5 items-center mb-5 bg-gray-200">
                            <div class="col-span-1 p-3">
                                <img src="{{ $team->image }}" alt="" class="w-full rounded-lg">
                            </div>
