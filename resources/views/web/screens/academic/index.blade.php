            ...
            <div class="grid grid-cols-3 gap-5">
                @foreach ($academics as $academic)
                    <a href="{{ route('academic.show', $academic) }}"
                        class="bg-gray-100 border border-gray-300 px-10 py-10 rounded-md text-gray-700 hover:bg-blue-900 hover:text-white flex items-center gap-5 text-4xl transition-all">
